...
<title>Server Error :: KOREAITACADEMY</title>
<style type="text/css"> 
* {margin:0;padding:0;}
...
#error_content {width:350px; _width /**/:600px; height:210px; _height:208px; margin:0 auto; margin-top:50px; padding:0 0 0 214px; border:1px solid #e5e5e5; background:#FFF url(http://static.naver.com/common/error/bg_error_s.gif) no-repeat 32px 48px; text-align:left;}
...
<div id="error_content">
	...
	<p>
		...
		<input type="button" value="확인" style="padding: 3px; color: #333333; border: 1px solid #ddd;" onclick="location.href='/member/login.do'"/>
	</p>
</div>
</body>
</html>
